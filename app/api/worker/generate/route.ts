...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const defaultPrompt = imageUrl ? "Enhance and realistically modify this scene" : "Standard professional portrait"
        enhancementPrompt = body.body?.prompt || defaultPrompt
